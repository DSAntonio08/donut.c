...
int main(void) {
    ...
    while (1) {
        ...
        // calculate circle
        for (float pointAngle = 0; pointAngle < 6.28;
             pointAngle += 0.1) // 6.28 = 2pi = 360deg but in radians
        {
            // calculate next x,y,z (point on the circus circumference) using
            // radius * cos/sin(Angle)
